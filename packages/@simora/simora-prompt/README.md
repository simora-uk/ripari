<div align="center">
  ...
  [npm-badge]: https://badgen.net/npm/v/@simora/simora-prompt?icon=npm&color=60a5fa&label=%40biomejs%2Fbiome
  [npm-url]: https://www.npmjs.com/package/@simora/simora-prompt/v/latest
...
<!-- Insert new entries lexicographically by language code.
     ...
     https://github.com/biomejs/biome/tree/main/packages/@simora/simora-prompt -->
...
```shell
npm install --save-dev --save-exact @simora/simora-prompt
```
...
```shell
# format files
npx @simora/simora-prompt format --write ./src

# lint files and apply the safe fixes
npx @simora/simora-prompt lint --write ./src

# run format, lint, etc. and apply the safe fixes
npx @simora/simora-prompt check --write ./src

# check all files against format, lint, etc. in CI environments
npx @simora/simora-prompt ci ./src
```
